...
A livello implementativo questo si traduce aumentando di un'unità l'arietà di ogni prodicato, in modo da includere la traccia in cui l'evento è stato generato. Se ad esempio l'aerietà di \textit{release} sarebbe 2, cioè se le sue variabili sono tempo e task, questa diventa 3, tempo, task e traccia.
